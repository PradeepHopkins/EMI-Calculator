Feature: Home Loan EMI Pie Chart Validation

  As a user
  I want to validate the EMI amount and pie chart for Home Loan
  So that I can confirm the values shown by the application

  Scenario Outline: Validate EMI amount and pie chart for Home Loan
